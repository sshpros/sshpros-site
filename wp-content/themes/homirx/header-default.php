...
$homirx_logo = HOMIRX_THEME_URL . '/assets/images/logo.png';
if(isset($homirx_options['header_logo']['url']) && $homirx_options['header_logo']['url']){
  $homirx_logo = $homirx_options['header_logo']['url'];
}
	...
	<div class="homirx-page-loading"></div>
  	...
  	<div class="wrapper-page"> <!--page-->
	 	...
	 	<header class="header-default">
			...
			<?php do_action( 'homirx_header_mobile' ); ?>
						...
						<div class="header-bottom-inner">
						  	...
						  	<div class="logo">
							 	<a class="logo-theme" href="<?php echo esc_url( home_url( '/' ) ); ?>">
									<img src="<?php echo esc_url($homirx_logo); ?>" alt="<?php bloginfo( 'name' ); ?>" />
							 	</a>
						  	</div>
					  		...
					  		<div class="main-menu-inner">
							 	<div class="content-innter clearfix">
									<div id="gva-mainmenu" class="main-menu">
								  		<?php do_action('homirx_main_menu'); ?>
									</div>
							 	</div> 
					  		</div>
