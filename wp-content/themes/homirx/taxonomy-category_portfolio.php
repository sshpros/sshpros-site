 ...
 */
	...
	$columns_lg = homirx_get_option('portfolio_columns_lg', '4');
	$columns_md = homirx_get_option('portfolio_columns_md', '3');
	$columns_sm = homirx_get_option('portfolio_columns_sm', '2');
	$columns_xs = homirx_get_option('portfolio_columns_xs', '1');
?>
