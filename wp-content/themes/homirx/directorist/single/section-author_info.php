...
<div class="property-card property-card-author-info <?php echo esc_attr( $class );?>" <?php $listing->section_id( $id ); ?>>
		...
		<div class="directorist-single-author-info">
			<div class="directorist-single-author-avatar">
				<div class="directorist-single-author-avatar-inner">
					<?php if ( $author_img ): ?>
						<img src="<?php echo esc_url( $author_img ); ?>" alt="<?php esc_attr_e( 'Avatar', 'homirx' );?>">
					<?php else: ?>
				...
				<div class="directorist-single-author-name">
					...
					<span class="directorist-single-author-membership"><?php printf( esc_html__( 'Member since %s ago', 'homirx' ), esc_html( $listing->author_info( 'member_since' ) ) ); ?></span>
				</div>
			...
			<a class="directorist-btn directorist-btn-primary directorist-btn-sm diretorist-view-profile-btn" href="<?php echo esc_url( ATBDP_Permalink::get_user_profile_page_link( $author_id ) ); ?>"><?php esc_html_e( 'View Profile', 'homirx' ); ?></a>
