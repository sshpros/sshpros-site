...
<section class="property-card directorist-related-listing property-block-style-4 <?php echo esc_attr( $class );?>" <?php $listing->section_id( $id ); ?>>

	<div class="directorist-related-listing-header property-card__header">

		<h3 class="directorist-related-listing-header__title property-card__header--title"><?php echo esc_html( $label );?></h3>

	</div>

	<div class='directorist-swiper directorist-swiper-related-listing' data-sw-items='3' data-sw-margin='30' data-sw-loop='false' data-sw-perslide='1' data-sw-speed='3000' data-sw-autoplay='true' data-sw-responsive='{
		"0": {"slidesPerView": "1"},
		"768": {"slidesPerView": "2"},
