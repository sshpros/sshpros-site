		...
		<div class="directorist-authors">
			...
			<?php if( $authors->display_sorting() ): ?>
				<div class="directorist-authors__nav">
					<ul>
						<li>
							<a href="#" class="directorist-alphabet ALL" data-nonce="<?php echo esc_attr( wp_create_nonce( 'directorist_author_sorting' ) ); ?>" data-alphabet="ALL"><?php esc_html_e( 'All', 'homirx' ); ?></a>
						</li>
			...
			<div class="directorist-authors__cards">
				<div class="directorist-row">
					...
					if( $authors->author_list() ):
								...
								<div class="directorist-authors__card">
									...
									<div class="directorist-authors__card__details">
										...
										<?php if( Helper::user_info( $author, 'description' ) && $authors->display_description() ): ?>
											<div class="directorist-authors__card__desc"><?php echo esc_html( wp_trim_words( Helper::user_info( $author, 'description' ), $authors->description_limit() ) ); ?></div>
										<?php endif; ?>
						...
						<div class="alert alert-info"><?php esc_html_e( 'No authors found', 'homirx' ); ?></div>

					<?php endif; ?>

				</div>

				<?php if( $authors->display_pagination() && $authors->author_pagination() ): ?>
