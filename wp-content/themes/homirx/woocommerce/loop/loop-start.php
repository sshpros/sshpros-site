 ...
 */
   ...
   $columns_lg = homirx_get_option('product_columns_lg', $std_lg);
   $columns_md = homirx_get_option('product_columns_md', $std_md);
   $columns_sm = homirx_get_option('product_columns_sm', $std_sm);
   $columns_xs = homirx_get_option('product_columns_xs', $std_xs);
?>
