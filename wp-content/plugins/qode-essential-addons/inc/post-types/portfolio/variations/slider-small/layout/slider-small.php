...
?>
	<article <?php post_class( 'qodef-portfolio-single-item qodef-variations--small qodef-e' ); ?>>
		<div class="qodef-e-inner">
			<div class="qodef-e-content qodef-grid qodef-layout--columns qodef-col-split--8-4 <?php echo qode_essential_addons_get_grid_gutter_classes(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
