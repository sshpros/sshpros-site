...
if ( ! function_exists( 'qode_essential_addons_add_minimal_header_options' ) ) {
	/**
	 ...
	 */
	function qode_essential_addons_add_minimal_header_options( $page, $general_header_tab ) {
		...
		do_action( 'qode_essential_addons_action_after_minimal_header_options_map', $section );
	}

	add_action( 'qode_essential_addons_action_after_header_options_map', 'qode_essential_addons_add_minimal_header_options', 10, 2 );
}
