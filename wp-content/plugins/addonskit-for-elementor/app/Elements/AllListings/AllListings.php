...
class AllListings extends Widget_Base {
    ...
    public function get_title(): string {
        return __('Listings', 'addonskit-for-elementor');
    }
    ...
    protected function add_filter_display_controls(): void {
		...
		$this->add_control(
			...
			[
				...
				'step'        => 1,
				'default'     => 6,
				'description' => __( 'Set -1 to display all listings', 'addonskit-for-elementor' ),
			]
		);
    ...
    protected function render(): void {
        ...
        Helper::run_shortcode('directorist_all_listing', $attributes);
    }
    ...
    private function prepare_attributes(array $settings): array {
        ...
        return apply_filters('directorist_all_listings_elementor_widget_atts', $attributes, $settings);
    }
