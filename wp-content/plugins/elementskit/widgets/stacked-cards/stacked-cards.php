...
class ElementsKit_Widget_Stacked_Cards extends Widget_Base {
	...
	public function get_script_depends() {
		return ['gsap', 'gsap-scroll-trigger'];
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				'label'     => esc_html__('Hover Border Color', 'elementskit'),
				'type'      => Controls_Manager::COLOR,
				'condition'   => [
					'content_type' => 'content',
					'show_button' => 'yes',
	...
	protected function ekit_stacked_card_data($settings) {
		...
		$card_data['hr_end'] = !empty($settings['ekit_stacked_card_hr_end']['size']) ? ($settings['ekit_stacked_card_hr_end']['size'] . $settings['ekit_stacked_card_hr_end']['unit']) : 0;
		return $card_data;
	}
