      ...
      if($post && $post->post_type === 'gva__template'){
         ...
         if($template_type == 'header_layout'){
            $document->add_control(
               'homirx_header_position',
               [
                  'label'     => esc_html__('Header Position', 'homirx-themer'),
                  'type'      => Controls_Manager::SELECT,
                  'options'   => array(
                     'relative'  => esc_html__('Relative', 'homirx-themer'),
                     'absolute'  => esc_html__('Absolute', 'homirx-themer'),
                  ),
                  'default' => 'relative',
               ]
            );
            $document->add_control(
               ...
               [
                  'label' => esc_html__('Background Black Demo', 'homirx-themer'),
         ...
         if($show_preview){
            $document->add_control(
               'homirx_post_preview',
               [
                  'label'     => esc_html__('Preview Content', 'homirx-themer'),
                  'type'      => Controls_Manager::SELECT,
