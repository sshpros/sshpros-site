...
class Gavias_Themer_Template{
	...
	public function args_post_type_template(){
		$labels = array(
			'name'               => esc_html__( 'Template', 'homirx-themer' ),
			'singular_name'      => esc_html__( 'Template', 'homirx-themer' ),
			'add_new'            => esc_html__( 'Add Template', 'homirx-themer' ),
			'add_new_item'       => esc_html__( 'Add Template', 'homirx-themer' ),
			'edit_item'          => esc_html__( 'Edit Template', 'homirx-themer' ),
			'new_item'           => esc_html__( 'New Template', 'homirx-themer' ),
			'view_item'          => esc_html__( 'View Template', 'homirx-themer' ),
			'search_items'       => esc_html__( 'Search Template Profiles', 'homirx-themer' ),
			'not_found'          => esc_html__( 'No Template Profiles found', 'homirx-themer' ),
			'not_found_in_trash' => esc_html__( 'No Template Profiles found in Trash', 'homirx-themer' ),
			'parent_item_colon'  => esc_html__( 'Parent Template:', 'homirx-themer' ),
			'menu_name'          => esc_html__( 'Templates & Layout', 'homirx-themer' ),
		);
