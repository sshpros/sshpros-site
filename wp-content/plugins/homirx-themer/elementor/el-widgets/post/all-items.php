...
class GVAElement_Posts extends GVAElement_Base{
	 ...
	 public function get_title() {
		  return __('Posts All Items', 'homirx-themer');
	 }
	 ...
	 protected function register_controls() {
		  ...
		  $this->add_control( // xx Layout
			...
			$this->add_control(
				...
				[
					 ...
					 'default' => 'carousel',
					 'options' => [
						  'standard'      => __('Standard', 'homirx-themer'),
						  'grid'          => __('Grid', 'homirx-themer'),
						  'carousel'      => __('Carousel', 'homirx-themer'),
						  'small_list'    => __('Small List', 'homirx-themer'),
						  'sticky'        => __('Post Large & List', 'homirx-themer')
					 ]
				]
		  );
		  $this->add_control(
				...
				[
					 ...
					 'options' => [
						  'post-style-1'         => __('Item Post Style I', 'homirx-themer'),
						  'post-style-2'         => __('Item Post Style II', 'homirx-themer'),
						  'post-style-3'         => __('Item Post Style III', 'homirx-themer')
					 ],
					 'condition' => [
		  	...
		  	$this->add_control(
				'excerpt_words',
				[
					'label'     => __('Excerpt Words', 'homirx-themer'),
					'type'      => 'number',
					'default'   => 15
				]
		  	);
		  	...
		  	$this->add_control(
				'post_ids',
				[
					'label' => __('Select Individually', 'homirx-themer'),
					'type' => Controls_Manager::SELECT2,
					'default' => '',
					'multiple'    => true,
					'label_block' => true,
		  	...
		  	$this->start_controls_section(
				...
				[
					'label' => __('Right List Posts Style', 'homirx-themer'),
		  	...
		  	$this->add_responsive_control(
				'stick_list_padding',
				[
					'label' => __('Padding List Posts', 'homirx-themer'),
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('Background List Posts', 'homirx-themer'),
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('List Posts Title Color', 'homirx-themer'),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('List Posts Meta Color', 'homirx-themer'),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		  	...
		  	$this->start_controls_section(
				...
				[
					'label' => __('Post Content', 'homirx-themer'),
					'tab'   => Controls_Manager::TAB_STYLE,
					'condition' => [
		  	...
		  	$this->add_responsive_control(
				'post_box_padding',
				[
					'label' => __('Padding Post Content', 'homirx-themer'),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%' ],
					'selectors' => [
		  ...
		  $this->add_control(
				'post_box_background',
				[
					 'label' => __('Background Post Content', 'homirx-themer'),
					 'type' => Controls_Manager::COLOR,
					 'default' => '',
					 'selectors' => [
		  ...
		  $this->start_controls_section(
				...
				[
					 'label' => __('Post Title', 'homirx-themer'),
					 'tab'   => Controls_Manager::TAB_STYLE,
					 'condition' => [
						  'layout' => ['grid', 'carousel']
					 ],
		  ...
		  $this->start_controls_section(
				...
				[
					 'label' => __('Post Description', 'homirx-themer'),
					 'tab'   => Controls_Manager::TAB_STYLE,
					 'condition' => [
						  'layout' => ['grid', 'carousel']
					 ],
