...
class GVAElement_Portfolio extends GVAElement_Base{
    ...
    public function get_title() {
        return esc_html__('Portfolio', 'homirx-themer');
    }
    ...
    private function get_categories_list(){
        ...
        $categories['none'] = esc_html__('None', 'homirx-themer');
    ...
    private function get_posts() {
        ...
        $posts['none'] = esc_html__('None', 'homirx-themer');
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_query',
            [
                'label' => esc_html__('Query & Layout', 'homirx-themer'),
        ...
        $this->add_control(
            'category_ids',
            [
                'label' => esc_html__('Select By Category', 'homirx-themer'),
        ...
        $this->add_control(
            'post_ids',
            [
                'label' => esc_html__('Select Individually', 'homirx-themer'),
                'type' => Controls_Manager::SELECT2,
                'default' => '',
                'multiple'    => true,
                'label_block' => true,
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label' => esc_html__('Posts Per Page', 'homirx-themer'),
        ...
        $this->add_control(
            'orderby',
            [
                'label'   => esc_html__('Order By', 'homirx-themer'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'homirx-themer'),
                    'post_title' => esc_html__('Title', 'homirx-themer'),
                    'menu_order' => esc_html__('Menu Order', 'homirx-themer'),
                    'rand'       => esc_html__('Random', 'homirx-themer'),
                ],
            ]
        );
        ...
        $this->add_control(
            'order',
            [
                'label'   => esc_html__('Order', 'homirx-themer'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'desc',
                'options' => [
                    'asc'  => esc_html__('ASC', 'homirx-themer'),
                    'desc' => esc_html__('DESC', 'homirx-themer'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'portfolio-style-1'         => esc_html__('Item Style 01', 'homirx-themer')
                ],
                'condition' => [
        ...
        $this->add_control(
            'content_max_width',
            [
               'label'     => esc_html__('Content Width', 'homirx-themer'),
        ...
        $this->add_control(
            'isotope_filter',
            [
                'label'     => esc_html__('Isotope Filter', 'homirx-themer'),
        ...
        $this->add_control(
            'pagination',
            [
                'label'     => esc_html__('Pagination', 'homirx-themer'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'no',
                'condition' => [
                    'layout' => 'grid'
