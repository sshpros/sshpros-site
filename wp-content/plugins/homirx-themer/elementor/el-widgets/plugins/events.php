...
class GVAElement_Events extends GVAElement_Base{
	...
	public function get_title() {
		return __('GVA Events', 'homirx-themer');
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'event_start_date' => __( 'Event Start Date', 'homirx-themer' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'event-1'     => __( 'Event Item Style I', 'homirx-themer' )
				],
				'default' => 'event-1',
				'condition' => [
