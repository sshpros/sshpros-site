...
class GVAElement_Post_Name extends GVAElement_Base{
	...
	public function get_title(){
		return esc_html__('Post Title', 'homirx-themer');
	}
	...
	protected function register_controls(){
		...
		$this->add_control(
			'html_tag',
			[
				'label' => esc_html__('Tag', 'homirx-themer'),
				'type' => Controls_Manager::SELECT,
				'options' => [
				  	'div' => esc_html__('DIV', 'homirx-themer'),
				  	'h1' => esc_html__('H1', 'homirx-themer'),
				  	'h2' => esc_html__('H2', 'homirx-themer'),
				  	'h3' => esc_html__('H3', 'homirx-themer'),
				  	'h4' => esc_html__('H4', 'homirx-themer'),
				  	'h5' => esc_html__('H5', 'homirx-themer'),
				],
				'default' => 'h1',
			]
		);
